...
The Gateway companion was contributed by [Richard Ahlquist (@rahlquist)](https://github.com/rahlquist)
in [PR #1](https://github.com/Adolanium/hermes-nous-prices/pull/1). His original commit
is preserved in the repository history. Thank you, Richard.
