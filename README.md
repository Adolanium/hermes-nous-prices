...
After catalog admission, use `hermes plugins update hermes-nous-prices` and rescan
...
releases use `catalog-v0.0.1-1` and are not marked as the latest standalone release.
